...
Running `npm install --workspaces --include=dev --include-workspace-root` in the root project will install all dependencies for all components. 
Any local packages which depend on one another will be linked locally (using symbolic links).
