...
#    Then I expect to receive a confirmation via GOV.UK Notify
    ...
    Examples:
      ...
      | 8dayLicence    | No       | Adult     | Licence  | 3       | SN153PG  | 100121002711 | Now      | salmon    |                         | 07845066408 |email@gmail.com|
  ...
  Scenario Outline: Scenario 2 - Purchase Fishing Adult Licence 1 and 8 days - Future start date
    ...
    *   I enter "<concession>" concession
    ...
    Examples:
      ...
      | 1dayLicence    | No           |Adult     | Licence  | 3       | SN153PG  | 100121002711 | AnotherTime     | midday       | salmon    |                        | 07845066408 | email@gmail.com            |
