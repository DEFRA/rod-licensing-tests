Feature: I want to renew my fishing licence
  ...
  Scenario: Scenario 5 - Renew my junior licence that expires in 2 days as a 14 year old on my birthday
  ...
  Scenario: Scenario 6 - Renew my junior licence that expires in 2 days as a 16 year old on my birthday
  ...
  Scenario: Scenario 7 - Renew my junior licence that expires today as a 16 year old the day before my 17th birthday
  ...
  Scenario: Scenario 8 - Renew my junior licence that expires in two days as a 16 year old on the day before my 17th birthday so I now need an adult licence
  ...
  Scenario: Scenario 9 - Renew my junior licence that expires today as a 17 year old on my birthday so I now need an adult licence
    Given I am at the start of the renewal journey with a "Coarse 12 month 2 Rod Licence (Junior)" licence, that expires in 0 days and I am 0 days over my 17th birthday and my name is "Bart" "SimpsonRenewal"
    And I enter "SN153PG" as the postcode and click continue
    And I am on the licence summary page and I click continue
    And I am on the contact summary page and I click continue
    And I agree to the terms and conditions and click continue
