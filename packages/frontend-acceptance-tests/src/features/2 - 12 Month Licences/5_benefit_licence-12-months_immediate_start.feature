...
Feature: I want to buy an adult disabled annual fishing
  ...
  Background: Buy an adult disabled fishing licence
    ...
    *   I enter "Benefit" as the ni concession and I enter "NP382939C" as the concesssion id
  ...
  Scenario: Scenario 2 - 12 Month Adult Benefit licence selecting salmon licence - Immediate start - Enter contact
  Licence details journey starts
 ...
 # Licence details journey starts
  ...
  Scenario: Scenario 4 - 12 Month Adult Benefit licence selecting salmon licence - Immediate start - By Post - Enter contact details
 # Licence details journey starts
    Given I select a "coarse3" fishing licence
    Then I am on the licence summary page and I click continue
  # Contact Journey starts
