...
# Scenario 2.2: Test Errors on Start Kind page -  Error messages - No date entered
...
# Scenario 2.3: Test Errors on Start Date page -  Error messages - No date entered
...
Scenario: Scenario 8 - Find Address Errors
#  Scenario 8.1: Test Errors on Find Address page -  Error messages - No date entered
    ...
    Then I expect the find address page to show the following errors
      ...
      | Enter your postcode                     |
#  Scenario 8.2: Test Errors on Find Address page -  Error messages - No date entered
...
Scenario: Scenario 9 - Select Address Errors
# Scenario 9.1: Test Errors on Select Address page -  Error messages - No date entered
...
Scenario: Scenario 10 - Confirmation Method Errors - Digital license
# Scenario 10.1: Test Errors on Confirmation Method page -  Error messages - Nothing selected
...
# Scenario 10.2: Test Errors on Confirmation Method page -  Error messages - No email entered
    And I click email radio button and click continue on confirmation method page
    Then I expect the confirmation method page to show the following errors
      | ErrorMessage   |
      | Enter an email address in the correct format |
# Scenario 10.3: Test Errors on Confirmation Method page -  Error messages - No phone number entered
...
Scenario: Scenario 11 - Contact Details Errors
# Scenario 11.1: Test Errors on Contact Details page -  Error messages - Nothing selected
...
Scenario: Scenario 12 - Licence Conditions Errors
# Scenario 12.1: Test Errors on Terms and Conditions page -  Error messages - No date entered
