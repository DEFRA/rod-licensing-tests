...
describe('createPermissions tests', () => {
  ;[
    {
      today: new Date(2020, 0, 1, 9, 15, 22),
      tomorrow: '2020-01-02T09:15:22.000Z',
      yesterday: '2019-12-31T09:15:22.000Z'
    },
    ...
    describe(`tests when today is ${today.toLocaleDateString()}`, () => {
      ...
      it('sets licensee date of birth to be 25 years ago yesterday', () => {
        ...
        expect(permission.licensee.birthDate).to.equal(
          `${dateOfBirth.getFullYear()}-${dateOfBirth.getMonth() + 1}-${dateOfBirth.getDate()}`
        )
      })
    })
  })
